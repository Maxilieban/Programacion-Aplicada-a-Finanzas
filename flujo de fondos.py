...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 16:50:18 2023
...
class FF():
    ...
    def tir_GS(self, a, b, n, tol):
       ...
       if (b-a) < tol:
          ...
          for i in range(n):
              if self.van(a+((i*(b-a))/n)) * self.van(a + (i+1)*((b-a)/n)) < 0:
                  tir = self.tir_GS((a+((i*(b-a))/n)), (a + (i+1)*((b-a)/n)), n, tol)
       return tir
    
    
    def tir_BI(self, a, b, n = 2, tol = 0.0001):
        return self.tir_GS(self, a, b, n, tol)
...
if __name__=='__main__':
    ...
    print(a.tir_GS(0, 1, 10, 0.0001))
    print(a.tir_BI(0, 1, 2, 0.0001))
